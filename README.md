...
- 📁 [Pinx](https://themeforest.net/item/pinx-vuejs-admin-template/47799543?ref=DverseStudio&utm_source=awesomevue) - Admin template built with Vue 3 and designed with Naive UI and Tailwind CSS. Nuxt compatible.
