...
- 💙🧩 [Typography](https://github.com/tailwindcss/typography) - Adds a `prose` class for beautiful typographic defaults.
- 💙🧩 [Custom Forms](https://github.com/tailwindcss/custom-forms) - Adds better default styles to form elements.
- 🎨 [Theming](https://github.com/hawezo/tailwindcss-theming) - Theming using CSS variables and variants, with dark mode support.
...
- 🎨 [Multi Theme](https://github.com/estevanmaito/tailwindcss-multi-theme) - Creates multiple themes based on a single `theme` property.
...
- 💼🔧 [Laravel Form Components](https://github.com/pascalbaljetmedia/laravel-form-components) - A set of Blade components to rapidly build forms with Tailwind CSS Custom Forms.
...
**Legend**: 🔧 Starters & Boilerplates · 💼 Starter packages · 🎨 Templates & Themes · 📟 Command line tool
...
- 🔧📟💼 [Laravel Front-end Preset](https://github.com/laravel-frontend-presets/tailwindcss) - Front-end preset using Tailwind CSS for the Laravel Framework.
- 🔧📟💼 [Laravel Dark Front-end Preset](https://github.com/Naoray/dark-tailwind-preset) - Dark-themed front-end preset using Tailwind CSS for the Laravel Framework.
