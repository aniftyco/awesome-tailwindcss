...
- 🚀 [Vite + React + TypeScript + Tailwind 3.x starter](https://github.com/PDMLab/vite-react-typescript-tailwind-starter) - GitHub Template for vite, React + tailwindcss 3 + TypeScript projects with some tools preconfigured
